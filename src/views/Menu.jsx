      ...
      {item.data.map((category, index, i) => {
        return (
          <View>
            ...
            <View style={{ flexDirection: 'row', paddingTop: 10, paddingBottom: 10, borderColor: colors.light_grey, borderTopWidth: 1, borderBottomWidth: 1}}>
          ...
          <View>
            <View style={{ margin: '15%' }}>
              <View style={{ height: 200 }}>
                <LottieView style={{flex:1}}source={no_menu_lottie} autoPlay loop />
              </View>
            </View>
