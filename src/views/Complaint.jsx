        ...
        {count == 0 ?
          <View style={{ flex: 1, justifyContent: 'center', height: '100%' }}>
            ...
            <View style={{ height: 250 }}>
              <LottieView style={{flex:1}}source={no_data_lottie} autoPlay loop />
            </View>
            {/* </View> */}
            <View style={{justifyContent:'center'}} >
              <Text style={{ alignSelf: 'center', fontFamily: bold, fontSize: 14, color: colors.grey, justifyContent: 'center' }}>Sorry no data found.</Text>
            </View>
          </View>
