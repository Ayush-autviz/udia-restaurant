    ...
    <SafeAreaView style={styles.container}>
      ...
      <Loader visible={loading} />
        ...
        <View style={styles.imageView}>
          <Image style= {{ height: 400,width: undefined,flex: 1,borderRadius:10 }} source={credit_card} />
          <View style={{ flexDirection:'row', width:'100%', padding:20, position:'absolute', top:10,}}>
            {/* <View style={{ width:'30%', alignItems:'flex-start', justifyContent:'flex-start' }}> */}
              <Image style= {{ height: 100, width:100,color:'white',tintColor:'white'}} source={require('../assets/img/wallet.png')}  />
            {/* </View> */}
            <View style={{ width:'70%', alignItems:'flex-start', justifyContent:'flex-end',marginLeft:20 }}>
        ...
        {count == 0 ?
         <View style={{marginTop:'10%'}}>
           <View style={{ height:250 }}>
             <LottieView style={{flex:1}}source={empty_wallet} autoPlay loop />
           </View>
